...
const Exam_Registration = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:5001/exam_register', formData);
    ...
    return (
        <Box maxWidth="500px" mx="auto" mt={4}>
            <Typography variant="h4" mb={2}>Exam Registration</Typography>
...
export default  Exam_Registration;
